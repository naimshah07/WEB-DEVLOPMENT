...
let firstName = new String("Naim Shah");
...
console.log(firstName.includes("Naim"));
console.log(firstName.startsWith("Naim"));
console.log(firstName.endsWith("Shah"));
console.log(firstName[0]);
let anotherName = firstName.replace("Naim", "khu") + "i";
...
course = courses.find(course => course.NAme === "Naim Shah");
console.log(course);
